...
#define FLEXCOM4_BASE      0xfc0180000

#define ATMEL_US_OFFSET		0x200	/* Offset to USART registers */

#define FLEXCOM4_US_BASE   (FLEXCOM4_BASE + ATMEL_US_OFFSET)

#define ATMEL_FLEX_MR		0x00	/* Mode Register */
#define ATMEL_FLEX_RHR		0x10	/* Receiver Holding Register */
#define ATMEL_FLEX_THR		0x20	/* Transmitter Holding Register */
...
typedef struct {
	uint32_t US_CR;       /**< \brief (Usart Offset: 0x0000) Control Register */
	uint32_t US_MR;       /**< \brief (Usart Offset: 0x0004) Mode Register */
	uint32_t US_IER;      /**< \brief (Usart Offset: 0x0008) Interrupt Enable Register */
	uint32_t US_IDR;      /**< \brief (Usart Offset: 0x000C) Interrupt Disable Register */
	uint32_t US_IMR;      /**< \brief (Usart Offset: 0x0010) Interrupt Mask Register */
	uint32_t US_CSR;      /**< \brief (Usart Offset: 0x0014) Channel Status Register */
	uint32_t US_RHR;      /**< \brief (Usart Offset: 0x0018) Receive Holding Register */
	uint32_t US_THR;      /**< \brief (Usart Offset: 0x001C) Transmit Holding Register */
	uint32_t US_BRGR;     /**< \brief (Usart Offset: 0x0020) Baud Rate Generator Register */
	uint32_t US_RTOR;     /**< \brief (Usart Offset: 0x0024) Receiver Timeout Register */
	uint32_t US_TTGR;     /**< \brief (Usart Offset: 0x0028) Transmitter Timeguard Register */
	uint32_t Reserved1[5];
	uint32_t US_FIDI;     /**< \brief (Usart Offset: 0x0040) FI DI Ratio Register */
	uint32_t US_NER;      /**< \brief (Usart Offset: 0x0044) Number of Errors Register */
	uint32_t Reserved2[1];
	uint32_t US_IF;       /**< \brief (Usart Offset: 0x004C) IrDA Filter Register */
	uint32_t US_MAN;      /**< \brief (Usart Offset: 0x0050) Manchester Configuration Register */
	uint32_t US_LINMR;    /**< \brief (Usart Offset: 0x0054) LIN Mode Register */
	uint32_t US_LINIR;    /**< \brief (Usart Offset: 0x0058) LIN Identifier Register */
	uint32_t US_LINBRR;   /**< \brief (Usart Offset: 0x005C) LIN Baud Rate Register */
	uint32_t Reserved3[12];
	uint32_t US_CMPR;     /**< \brief (Usart Offset: 0x0090) Comparison Register */
	uint32_t Reserved4[3];
	uint32_t US_FMR;      /**< \brief (Usart Offset: 0x00A0) FIFO Mode Register */
	uint32_t US_FLR;      /**< \brief (Usart Offset: 0x00A4) FIFO Level Register */
	uint32_t US_FIER;     /**< \brief (Usart Offset: 0x00A8) FIFO Interrupt Enable Register */
	uint32_t US_FIDR;     /**< \brief (Usart Offset: 0x00AC) FIFO Interrupt Disable Register */
	uint32_t US_FIMR;     /**< \brief (Usart Offset: 0x00B0) FIFO Interrupt Mask Register */
	uint32_t US_FESR;     /**< \brief (Usart Offset: 0x00B4) FIFO Event Status Register */
	uint32_t Reserved5[11];
	uint32_t US_WPMR;     /**< \brief (Usart Offset: 0x00E4) Write Protection Mode Register */
	uint32_t US_WPSR;     /**< \brief (Usart Offset: 0x00E8) Write Protection Status Register */
} Atmel_Usart;

typedef struct {
	uint32_t FLEX_MR;       /**< \brief Mode Register */
	uint32_t Reserved1[3];
	uint32_t US_RHR;      /**< \brief Receive Holding Register */
	uint32_t Reserved2[3];
	uint32_t US_THR;      /**< \brief Transmit Holding Register */
} Atmel_flexcom;
